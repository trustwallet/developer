...
```swift
let utxoTxId = Data(hexString: "050d00e2e18ef13969606f1ceee290d3f49bd940684ce39898159352952b8ce2")! // latest tx id for sender, get from blockchain "txix"
...
let utxo = BitcoinUnspentTransaction.with {
    ...
    $0.outPoint.index = 2                        // outpoint index of this this UTXO // index from latest transaction vout array, need get index for transaction which was connected to send back balance to sender walled
    $0.outPoint.sequence = UINT32_MAX
    $0.amount = 5151                             // value of this UTXO - need get from value property vout[index]
...
let input = BitcoinSigningInput.with {
    ...
    $0.changeAddress = "1FQc5LdgGHMHEN9nwkjmz6tWkxhPpxBvBU" // can be a same as sender
    $0.utxo = [utxo]
