...
1. [Introducing Barz: Trust Wallet’s Smart Wallet Solution](/barz-smart-wallet/introducing-barz-trustwallet-smart-wallet-solution)
2. [Cutting Diamonds: How to make Accounts Awesome](/barz-smart-wallet/cutting-diamonds-how-to-make-accounts-awesome)
...
![Barz Architecture Diagram](/img/barz-diagram.png)
...
![Conventional Proxy Pattern e.g., UUPS](/img/conventional-proxy-pattern.png)
...
![Diamond Proxy Pattern](/img/diamond-proxy-pattern.png)
...
![Illustrated example of Barz storage per Facet](/img/barz-storage-management.png)
...
![Overview of Barz account from louper.dev](/img/louper-barz.png)
...
![Barz deploment and initalization flow](/img/barz-deployment-initialization-flow.png)
...
![Barz UserOp Validation Flow](/img/barz-userop-validation-flow.png)
