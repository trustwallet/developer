...
![Adding AccountRecoveryFacet with diamondCut()](/img/add-recovery-facet.png)
...
![FacetRegistry forbidding malicious Facets from being added](/img/facet-registry.png)
...
![Barz account in louper.dev](/img/diamond-louper-dev.png)
