...
1. [ERC20](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20), ERC223 tokens on Ethereum compatible networks such as:
...
2. Binance DEX tokens (native marketplace on Binance Chain)
   - [BEP2](https://github.com/binance-chain/BEPs/blob/master/BEP2)
   - [BEP8](https://github.com/binance-chain/BEPs/blob/master/BEP8)
