...
- For building locally, or using Docker image, see the [Build Instructions](building).
- For trying out, e.g. testing key management and address derivation, see the [WalletConsole utility](walletconsole).
- If you want to include Wallet Core in your project, see the [Integration Guides](integration-guide).
  Start with the overview of the most common wallet operations ([Usage Guide](wallet-core-usage)),
  and see the platform-specifc guides for
  [iOS](ios-guide) and
  [Android](android-guide).
- We have a [FAQ](faq) list may already answer some of your questions.
...
If you want to contribute code please see [Contributing](contributing).
If you want to add support for a new blockchain also see [Adding Support for a New Blockchain](newblockchain).
