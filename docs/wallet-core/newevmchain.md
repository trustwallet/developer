...
- Start with an up-to-date workspace ([more info](contributing)).
...
- Update generated sources, build the project, execute unit tests (see [building](building)):
