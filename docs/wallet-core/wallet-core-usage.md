---
title: Wallet Core Usage Guide
---

# Wallet Core Usage Guide

We present here an overview of the basic wallet operations. Language-specific samples are provided in step-by-step [guides](integration-guide).
...
| coinType      | 145                                        | [SLIP44 Index](https://github.com/trustwallet/wallet-core/blob/master/docs/registry) coin type, default is 0 / Bitcoin                                    |
...
| source        | 0                  | [BEP10](https://github.com/binance-chain/BEPs/blob/master/BEP10) source id                                                                                     |
