...
![](/img/sourcetrail-screenshot.png)
...
Please refer to [build instructions](building) for building the library locally.
...
- [Adding Support for a New Blockchain](newblockchain)
- [Releasing](releasing)
