---
title: How to debug your DApp on Trust Wallet
---
...
<img src="/img/js-eth-sign.png" width="45%" /> <img src="/img/js-eth-sign-console.png" width="45%" />
...
<img src="/img/android-install-apk-emulator.png" width="45%" /> <img src="/img/android-dapp-emulator.png" width="45%" />

Visit `chrome://inspect/#devices` or `edge://inspect/#devices` to inspect the web console

![Edge inspect](/img/edge-inspect.png)
![Edge inspect](/img/edge-inspect2.png)
